...
use Edmunds\Http\Responses\ContentResponse;
use Edmunds\Http\Responses\DownloadResponse;
use Edmunds\Http\Responses\JsonResponse;
use Edmunds\Http\Responses\RedirectResponse;
use Edmunds\Http\Responses\ViewResponse;
use Edmunds\Http\Responses\XmlResponse;
