...
namespace Edmunds\Gae\Console\Process;
...
use Symfony\Component\Process\Process as OriginalProcess;
use Symfony\Component\Process\ProcessUtils;

/**
 * This is a copy of the Symfony Symfony\Component\Process\Process-class.
 * The properties of the original class are private, so you can't do shit when extending from it.
 */
class SymfonyProcess extends OriginalProcess
{
	const ERR = 'err';
	const OUT = 'out';
	...
	protected $options;
	protected $exitcode;
	protected $fallbackStatus = array();
	 ...
	 */
	protected function readPipes($blocking, $close)
	{
	 ...
	 */
	protected function requireProcessIsStarted($functionName)
	{
		if (!$this->isStarted()) {
	 ...
	 */
	protected function requireProcessIsTerminated($functionName)
	{
