...
class TestRolesAcceptedMiddleware(TestCase):
    ...
    def set_up(self):
        ...
        super(TestRolesAcceptedMiddleware, self).set_up()
    ...
    def test_no_user_check(self):
        ...
        # Add route
        @app.route(rule, middleware=[(RolesAcceptedMiddleware, self.role_name)])
        def handle_route():
            return ''
    ...
    def test_unauthorized(self):
        ...
        # Add route
        @app.route(rule, middleware=[BasicAuthMiddleware, (RolesAcceptedMiddleware, self.role_name)])
        def handle_route():
            return ''
    ...
    def test_some_forbidden(self):
        ...
        # Add route
        @app.route(rule_1, middleware=[BasicAuthMiddleware, (RolesAcceptedMiddleware, self.role_name)])
        def handle_route_1():
            return ''

        @app.route(rule_2, middleware=[BasicAuthMiddleware, (RolesAcceptedMiddleware, self.role_second_name)])
        def handle_route_2():
            return ''

        @app.route(rule_3, middleware=[BasicAuthMiddleware, (RolesAcceptedMiddleware, self.role_name, self.role_second_name)])
        def handle_route_3():
            return ''
